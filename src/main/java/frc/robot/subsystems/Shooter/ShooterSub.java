...
public class ShooterSub extends SubsystemBase {
  ...
  public ShooterSub() {
    ...
    shooterLMotor = new SparkMax(Constants.ShooterConstants.shooterLID, MotorType.kBrushless);
      ...
      shooterLMotor.configure(shooterLConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    ...
    shooterFMotor = new SparkMax(Constants.ShooterConstants.shooterFID, MotorType.kBrushless);
      ...
      shooterFMotor.configure(shooterFConfig, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    ...
    public boolean atRPM(double targetRPM){
        return Math.abs(shooterLEncoder.getVelocity() - targetRPM) < Constants.ShooterConstants.RPM_TOLERANCE;
    }
