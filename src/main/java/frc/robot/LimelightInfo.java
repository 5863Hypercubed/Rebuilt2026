// LimelightInfo v1.12 (REQUIRES LLOS 2025.0 OR LATER)
...
/**
 * LimelightInfo provides static methods and classes for interfacing with Limelight vision cameras
 * in FRC. This library supports all Limelight features including AprilTag tracking, Neural
...
public class LimelightInfo {
  ...
  private static PoseEstimate getBotPoseEstimate(
    ...
    DoubleArrayEntry poseEntry =
        LimelightInfo.getLimelightDoubleArrayEntry(limelightName, entryName);
  ...
  public static RawFiducial[] getRawFiducials(String limelightName) {
    var entry = LimelightInfo.getLimelightNTTableEntry(limelightName, "rawfiducials");
  ...
  public static RawDetection[] getRawDetections(String limelightName) {
    var entry = LimelightInfo.getLimelightNTTableEntry(limelightName, "rawdetections");
  ...
  public static LimelightResults getLatestResults(String limelightName) {
    ...
    LimelightInfo.LimelightResults results = new LimelightInfo.LimelightResults();
    if (mapper == null) {
      mapper =
